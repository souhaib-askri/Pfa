...
\begin{center}
    ...
    % Insérer le logo
    \includegraphics[width=0.5\textwidth]{./img/tt.png} % Ajustez la taille selon vos besoins
    \vspace{3cm} % Espace après le logo
    
    {\Large Rapport de Projet\par} % Ajouter le titre du rapport
    \vspace{3cm}
